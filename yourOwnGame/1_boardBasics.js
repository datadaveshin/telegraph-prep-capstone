...
var check = "I am in the local scope, try to access me from the browser console"

"Then try to console.log gameBoard from the browser console"
...
console.log("gameBoard is:", gameBoard);
  ...
  //##################################################
console.log('\n\nSection 1, Part 2') 
console.log('Used _.each to iterate through the gameBoard array and print each row:')
...
console.log('\n\nSection 1, Part 3');
console.log('Here is each object in the first row of the gameBoard Object, generated by _.each');
...
"gameBoard[3][5].color = 'black'; will change the color property value in the gameBoard Object to the string black"
  ...
  //#############################################
  console.log('\n\nSection 1, Part 4') 
  console.log('Using _.each to iterate through first row and print each item again:')
  _.each(gameBoard[0], function(obj) {
      console.log(obj);
  });

  //#############################################
  // What is it that's being passed into each invocation of our callback? 

"What is being passed into each invocation is an object that represents a square in our array"
